        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-5 mb-10">
            ...
            <div class="flex gap-3 flex-wrap">
                <button onclick="filterHistory('all', this)"
                        class="filter-btn px-5 py-2.5 rounded-xl font-semibold text-sm border-2 border-green-500 bg-gradient-to-br from-green-600 to-green-400 text-white transition-all duration-300">
                    Semua
                </button>
                <button onclick="filterHistory('success', this)"
                ...
                <button onclick="filterHistory('failed', this)"
                        class="filter-btn px-5 py-2.5 rounded-xl font-semibold text-sm border-2 border-neutral-200 bg-white text-neutral-700 hover:border-green-500 hover:text-green-600 transition-all duration-300">
                    Gagal
                </button>
            </div>
        ...
        <div class="bg-white rounded-2xl p-8 shadow-sm">
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
                ...
                <div class="relative">
                    ...
                    <input type="text" placeholder="Cari transaksi..."
                           ...
                           class="pl-10 pr-4 py-2.5 w-72 border-2 border-neutral-200 rounded-xl text-sm focus:outline-none focus:border-green-500 transition-all duration-300">
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full border-separate border-spacing-y-3" id="historyTable">
                    <thead>
                        <tr>
                            <th class="text-left px-4 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Jenis Pajak</th>
                            <th class="text-left px-4 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Tanggal</th>
                            <th class="text-left px-4 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Jumlah</th>
                            <th class="text-left px-4 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Metode</th>
                            <th class="text-left px-4 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Status</th>
                            <th class="text-left px-4 py-3 text-xs font-semibold text-neutral-500 uppercase tracking-wider">Aksi</th>
                        </tr>
                    </thead>
        ...
        <div class="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden">
            ...
            <div id="buktContent" class="px-7 py-5 space-y-3">
                <div class="flex justify-between text-sm">
                    ...
                    <span class="font-mono text-xs font-semibold text-neutral-700" id="popId">-</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-neutral-400">Nama</span>
                    <span class="font-semibold text-neutral-800" id="popUser">-</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-neutral-400">Nomor Kios</span>
                    <span class="font-semibold text-neutral-800" id="popKios">-</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-neutral-400">Jenis Pajak</span>
                    <span class="font-semibold text-neutral-800" id="popJenis">-</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-neutral-400">Metode Bayar</span>
                    <span class="font-semibold text-neutral-800" id="popMetode">-</span>
                </div>
                <div class="flex justify-between text-sm">
                    <span class="text-neutral-400">Status</span>
                    <span class="px-3 py-0.5 rounded-full bg-green-100 text-green-700 text-xs font-bold">✓ Berhasil</span>
                </div>
            </div>
            ...
            <div class="p-5 flex gap-3">
                ...
                <button onclick="simpanBukti()"
                        class="flex-1 py-2.5 bg-gradient-to-r from-green-700 to-green-500 text-white rounded-xl text-sm font-semibold hover:shadow-lg hover:shadow-green-200 transition flex items-center justify-center gap-2">
                     Simpan
                </button>
            </div>
        </div>
                ...
                row.innerHTML = `
                    ...
                    <td class="px-4 py-4 rounded-r-xl">
                        <button onclick='bukaPopup(${JSON.stringify(trx)})'
                                class="px-4 py-2 bg-gradient-to-br from-green-600 to-green-400 text-white text-xs font-semibold rounded-lg
                                       hover:-translate-y-0.5 hover:shadow-lg hover:shadow-green-200 transition-all duration-300">
                             Unduh Bukti
                        </button>
                    </td>`;
...
function updateStats(data) {
            ...
            document.getElementById('statRataRata').innerText = 'Rp ' + rata.toLocaleString('id-ID');
        }
        ...
        function bukaPopup(trx) {
            ...
            document.getElementById('popUser').innerText   = trx.user || sessionStorage.getItem("user") || '-';
