...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0d1a10] via-[#125B2A] to-[#1a3c26] text-white">
    <div class="text-center max-w-xl p-10 backdrop-blur-md bg-white/5 rounded-3xl shadow-xl">
        <img src="<?php echo e(asset('images/logo-sipesel.png')); ?>" class="w-32 mx-auto mb-6" alt="Logo">
        ...
        <div class="flex justify-center gap-4">
            <a href="<?php echo e(route('login')); ?>" class="bg-yellow-400 text-green-900 px-6 py-3 rounded-full font-semibold hover:scale-105 transition">Masuk</a>
            <a href="<?php echo e(route('register')); ?>" class="border border-white/30 px-6 py-3 rounded-full hover:bg-white/20 transition">Daftar</a>
        </div>
        <div class="mt-8 text-sm opacity-60">&copy; 2026 SIPESEL</div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\Sipesel\resources\views/welcome.blade.php ENDPATH**/ ?>