...
<body class="min-h-screen flex items-center justify-center bg-cover bg-center"
      style="background-image: url('<?php echo e(asset('images/kios-pasar.jpg.jpeg')); ?>');">
...
<div class="relative z-10 bg-white/10 backdrop-blur-lg p-8 md:p-10 rounded-2xl w-[90%] max-w-sm text-white text-center shadow-2xl">
    <img src="<?php echo e(asset('images/logo-sipesel.png')); ?>" class="w-24 mx-auto mb-4" alt="Logo SIPESEL">
    <h2 class="text-xl md:text-2xl font-semibold mb-6">LOGIN</h2>

    <?php if(session('success')): ?>
    <div class="bg-green-500/80 text-white text-sm p-3 rounded-lg mb-4"><?php echo e(session('success')); ?></div>
    <?php endif; ?>
    <?php if($errors->any()): ?>
    <div class="bg-red-500/80 text-white text-sm p-3 rounded-lg mb-4"><?php echo e($errors->first()); ?></div>
    <?php endif; ?>
    ...
    <p class="text-sm text-gray-200 mt-6">
        Belum punya akun?
        <a href="<?php echo e(route('register')); ?>" class="text-yellow-400 font-semibold hover:underline">Daftar di sini</a>
    </p>
</div>

</body>
</html><?php /**PATH C:\xampp\htdocs\Sipesel\resources\views/auth/login.blade.php ENDPATH**/ ?>