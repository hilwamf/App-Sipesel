...
<body style="background-image:url('<?php echo e(asset('images/kios2.jpg')); ?>');" class="min-h-screen bg-cover bg-center flex items-center justify-center p-4">
...
<div class="relative z-10 flex w-full max-w-5xl rounded-2xl overflow-hidden shadow-2xl">
    ...
    <div class="w-full md:w-1/2 bg-white p-8 md:p-10 overflow-y-auto max-h-screen">
        ...
        <?php if($errors->any()): ?>
        <div class="mb-4 p-3 rounded-lg bg-red-100 text-red-800 border border-red-300"><?php echo e($errors->first()); ?></div>
        <?php endif; ?>

        <form method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data" autocomplete="off" class="space-y-4">
            <?php echo csrf_field(); ?>
            ...
            <select id="role" name="role" required
                ...
                <option value="pedagang" <?php echo e(old('role')=='pedagang'?'selected':''); ?>>Pedagang</option>
                <option value="pengawas" <?php echo e(old('role')=='pengawas'?'selected':''); ?>>Pengawas</option>
            </select>
            ...
            <div id="kios_container" style="display:none;">
                <select id="no_kios" name="no_kios"
                    ...
                    <?php $__currentLoopData = $kiosList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kios): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($kios->no_kios); ?>" <?php echo e(old('no_kios')==$kios->no_kios?'selected':''); ?>>
                        <?php echo e($kios->no_kios); ?> — <?php echo e($kios->lokasi); ?>

                    </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($kiosList->isEmpty()): ?>
            ...
            <div>
                ...
                <div class="flex gap-6">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="gender" value="Laki-laki" required class="w-4 h-4 text-green-600" <?php echo e(old('gender')=='Laki-laki'?'checked':''); ?>>
                        <span class="text-gray-700">Laki-laki</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="radio" name="gender" value="Perempuan" required class="w-4 h-4 text-green-600" <?php echo e(old('gender')=='Perempuan'?'checked':''); ?>>
        ...
        <p class="text-sm text-center mt-5 text-gray-600">
            Sudah punya akun?
            <a href="<?php echo e(route('login')); ?>" class="text-green-700 font-semibold hover:underline">Login sekarang</a>
        </p>
    </div>
</div>
...
</html><?php /**PATH C:\xampp\htdocs\Sipesel\resources\views/auth/register.blade.php ENDPATH**/ ?>