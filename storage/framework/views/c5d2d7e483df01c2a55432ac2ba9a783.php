...
<div class="max-w-6xl mx-auto px-6 py-8">
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-5 mb-10">
        <div>
            ...
            <p class="text-neutral-500 text-sm mt-1">Halo, <span class="font-semibold text-green-700"><?php echo e($user->nama); ?></span> — menampilkan transaksi kios Anda</p>
        </div>
...
window.onload=function(){
    allData=<?php echo json_encode($transaksi, 15, 512) ?>;
    renderTable(allData);
    updateStats(allData);
};
