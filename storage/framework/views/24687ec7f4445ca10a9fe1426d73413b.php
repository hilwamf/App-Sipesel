...
<?php $__env->startSection('title','Edit Profil - SIPESEL'); ?>
<?php $__env->startSection('page-title','Edit Profil'); ?>
<?php $__env->startSection('page-sub','Perbarui data diri Anda'); ?>
...
<?php endif; ?>
<?php if($errors->any()): ?>
<div class="bg-red-50 border border-red-200 text-red-700 rounded-xl px-5 py-3 mb-5 text-sm"><?php echo e($errors->first()); ?></div>
<?php endif; ?>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    ...
    <div class="bg-gradient-to-r from-green-700 to-green-600 px-6 py-5 flex items-center gap-4">
        ...
        <div class="text-white">
            ...
            <p class="text-green-200 text-sm"><?php echo e($user->username); ?> · <span class="capitalize"><?php echo e($user->role); ?></span></p>
        </div>
    </div>

    
    <form method="POST" action="<?php echo e(route('profil.update')); ?>" class="p-6">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.sidebar-admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Sipesel\resources\views/profile/edit.blade.php ENDPATH**/ ?>