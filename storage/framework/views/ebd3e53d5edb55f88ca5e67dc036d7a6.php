...
<?php $__env->startSection('page-sub','Konfigurasi tarif dan parameter sistem'); ?>
...
<div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
    <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 text-center">
        <p class="text-2xl font-black text-gray-800"><?php echo e($sysStats['total_user']); ?></p>
        <p class="text-xs text-gray-400 mt-1">Total User</p>
    </div>
    <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 text-center">
        <p class="text-2xl font-black text-gray-800"><?php echo e($sysStats['total_kios']); ?></p>
        <p class="text-xs text-gray-400 mt-1">Total Kios</p>
    </div>
    <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 text-center">
        <p class="text-2xl font-black text-gray-800"><?php echo e($sysStats['total_transaksi']); ?></p>
    ...
    <div class="bg-white rounded-2xl p-4 shadow-sm border border-yellow-100 text-center">
        <p class="text-2xl font-black text-yellow-600"><?php echo e($sysStats['total_pending']); ?></p>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
    <div class="lg:col-span-2 space-y-4">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <form id="formGenerate" method="POST" action="<?php echo e(route('admin.generate-tagihan')); ?>">
                <?php echo csrf_field(); ?>
                <div class="divide-y divide-gray-50">
                    <div class="px-5 py-4 flex items-center gap-4 flex-wrap">
                        ...
                        <div class="flex items-center gap-2"><span class="text-xs text-gray-500">Rp</span>
                            <input type="number" name="settings[harian_rate]" value="<?php echo e($harian); ?>" min="0" required
                    ...
                    <div class="px-5 py-4 flex items-center gap-4 flex-wrap">
                        ...
                        <div class="flex items-center gap-2"><span class="text-xs text-gray-500">Rp</span>
                            <input type="number" name="settings[mingguan_rate]" value="<?php echo e($mingguan); ?>" min="0" required
                                class="px-4 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 w-36 font-semibold">
                        </div>
                    </div>
                    <div class="px-5 py-4 flex items-center gap-4 flex-wrap">
                        ...
                        <div class="flex items-center gap-2"><span class="text-xs text-gray-500">Rp</span>
                            <input type="number" name="settings[bulanan_rate]" value="<?php echo e($bulanan); ?>" min="0" required
                                class="px-4 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-green-500 w-36 font-semibold">
                        </div>
                    </div>
                </div>
        ...
        <?php if($settingLain->count() > 0): ?>
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100">
                <h2 class="font-bold text-gray-800 text-sm">Setting Tambahan</h2>
            </div>
            <div class="divide-y divide-gray-50">
                <?php $__currentLoopData = $settingLain; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="px-5 py-3 flex items-center gap-3 flex-wrap hover:bg-gray-50">
                    <div class="flex-1 min-w-32">
                        <p class="font-mono text-sm font-semibold text-blue-700"><?php echo e($s->nama_setting); ?></p>
                        <p class="text-xs text-gray-400"><?php echo e($s->deskripsi ?? '-'); ?></p>
                    </div>
                    <span class="text-sm font-semibold text-gray-700 flex-1"><?php echo e($s->nilai); ?></span>
                    
                    <form method="POST" action="<?php echo e(route('admin.hapus-setting')); ?>" onsubmit="return confirm('Hapus setting <?php echo e($s->nama_setting); ?>?')">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="id_setting" value="<?php echo e($s->id_setting); ?>">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center py-1 border-b border-gray-50">
                    ...
                    <span class="font-black text-green-700">Rp <?php echo e(number_format($harian,0,',','.')); ?></span>
                </div>
                <div class="flex justify-between items-center py-1 border-b border-gray-50">
                    <span class="text-sm text-gray-500">Mingguan</span>
                    <span class="font-black text-green-700">Rp <?php echo e(number_format($mingguan,0,',','.')); ?></span>
                </div>
                <div class="flex justify-between items-center py-1">
                    <span class="text-sm text-gray-500">Bulanan</span>
                    <span class="font-black text-green-700">Rp <?php echo e(number_format($bulanan,0,',','.')); ?></span>
                </div>
            </div>
