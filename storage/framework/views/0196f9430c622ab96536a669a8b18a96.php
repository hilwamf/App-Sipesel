...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SIPESEL Admin'); ?></title>
...
<aside id="sidebar" class="sidebar flex flex-col flex-shrink-0">
    ...
    <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
        ...
        <a href="<?php echo e(route('admin.verifikasi')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.verifikasi') ? 'active' : ''); ?>">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
            <span class="nav-label">Verifikasi</span>
            <?php if($totalPendingNav > 0): ?><span class="badge nav-label"><?php echo e($totalPendingNav); ?></span><?php endif; ?>
        </a>
        ...
        <a href="<?php echo e(route('admin.berita')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.berita') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('admin.kios')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.kios') ? 'active' : ''); ?>">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
            <span class="nav-label">Kios</span>
        </a>
        <a href="<?php echo e(route('admin.setting')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.setting') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('pengawas.monitoring')); ?>" class="nav-item <?php echo e(request()->routeIs('pengawas.monitoring') ? 'active' : ''); ?>">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
            <span class="nav-label">Monitoring</span>
        </a>
        <a href="<?php echo e(route('pengawas.laporan')); ?>" class="nav-item <?php echo e(request()->routeIs('pengawas.laporan') ? 'active' : ''); ?>">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
            <span class="nav-label">Laporan</span>
        </a>
        <?php endif; ?>
    ...
    <div class="px-3 py-4 border-t border-white/10">
        <div class="flex items-center gap-3 px-2 py-2">
            ...
            <div class="user-info flex-1 min-w-0">
                <p class="text-white text-xs font-semibold truncate"><?php echo e(auth()->user()->username); ?></p>
                <p class="text-white/40 text-[10px] truncate"><?php echo e(ucfirst(auth()->user()->role)); ?></p>
            </div>
        </div>
...
<div class="main-content flex flex-col min-h-screen">
    ...
    <header class="bg-white border-b border-gray-100 px-6 py-3 flex items-center justify-between sticky top-0 z-40">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="font-bold text-gray-800 text-base"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
                <p class="text-gray-400 text-xs"><?php echo $__env->yieldContent('page-sub', now()->locale('id')->isoFormat('dddd, D MMMM YYYY')); ?></p>
            </div>
        </div>
        <div class="flex items-center gap-3">
            <?php if($isAdmin && $totalPendingNav > 0): ?>
            <a href="<?php echo e(route('admin.verifikasi')); ?>" class="flex items-center gap-2 bg-red-50 text-red-600 px-3 py-1.5 rounded-lg text-xs font-semibold hover:bg-red-100 transition">
                <span class="w-2 h-2 bg-red-500 rounded-full animate-pulse"></span>
                <?php echo e($totalPendingNav); ?> Pending
            </a>
            <?php endif; ?>
            <a href="<?php echo e(route('profil.edit')); ?>" class="flex items-center gap-2 px-3 py-1.5 rounded-lg border border-gray-200 hover:bg-gray-50 transition">
                <div class="w-6 h-6 rounded-full bg-green-600 flex items-center justify-center text-white font-bold text-xs"><?php echo e(strtoupper(substr(auth()->user()->username,0,1))); ?></div>
                <span class="text-sm text-gray-700 hidden sm:block"><?php echo e(auth()->user()->username); ?></span>
            </a>
        </div>
    </header>
...
</html><?php /**PATH C:\xampp\htdocs\Sipesel\resources\views/layouts/sidebar-admin.blade.php ENDPATH**/ ?>