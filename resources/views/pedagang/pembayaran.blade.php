...
@if(!$dataSukses)
{{-- FORM PEMBAYARAN --}}
<form action="{{ route('pedagang.proses-bayar') }}" method="POST" id="formPembayaran">
    @csrf
    ...
    <div class="max-w-3xl mx-auto px-6 py-10">
        ...
        <div class="bg-white rounded-2xl p-8 shadow-sm border-t-4 border-green-600 mb-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="jenis-card border-2 border-neutral-200 rounded-2xl p-5 relative" onclick="pilihJenis(this,'Harian',{{ $tarif['harian'] }})">
                    ...
                    <p class="font-extrabold text-2xl text-green-600" style="font-family:'Montserrat',sans-serif;">Rp {{ number_format($tarif['harian'],0,',','.') }}</p>
                </div>
                <div class="jenis-card border-2 border-neutral-200 rounded-2xl p-5 relative" onclick="pilihJenis(this,'Mingguan',{{ $tarif['mingguan'] }})">
                    <div class="jenis-check absolute top-3 right-3 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-white text-xs font-bold">✓</div>
                    <h3 class="font-bold text-neutral-800 mb-1">Mingguan</h3>
                    <p class="text-neutral-400 text-xs mb-3">Pembayaran per minggu</p>
                    <p class="font-extrabold text-2xl text-green-600" style="font-family:'Montserrat',sans-serif;">Rp {{ number_format($tarif['mingguan'],0,',','.') }}</p>
                </div>
                <div class="jenis-card border-2 border-neutral-200 rounded-2xl p-5 relative" onclick="pilihJenis(this,'Bulanan',{{ $tarif['bulanan'] }})">
                    <div class="jenis-check absolute top-3 right-3 w-6 h-6 bg-green-500 rounded-full flex items-center justify-center text-white text-xs font-bold">✓</div>
                    <h3 class="font-bold text-neutral-800 mb-1">Bulanan</h3>
                    <p class="text-neutral-400 text-xs mb-3">Pembayaran per bulan</p>
                    <p class="font-extrabold text-2xl text-green-600" style="font-family:'Montserrat',sans-serif;">Rp {{ number_format($tarif['bulanan'],0,',','.') }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-8 shadow-sm border-t-4 border-green-600 mb-6">
            ...
            <input type="text" id="nomorKios" value="{{ $user->no_kios }}" readonly
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div class="metode-card border-2 border-neutral-200 rounded-xl p-4 flex items-center gap-4" onclick="pilihMetode(this,'DANA')">
                    <div class="w-12 h-12 bg-green-100 rounded-xl overflow-hidden flex-shrink-0">
                        <img src="{{ asset('images/DANA.jpg') }}" alt="DANA" class="w-full h-full object-cover">
                    </div>
                ...
                <div class="metode-card border-2 border-neutral-200 rounded-xl p-4 flex items-center gap-4" onclick="pilihMetode(this,'Transfer Bank')">
                    <div class="w-12 h-12 bg-blue-100 rounded-xl overflow-hidden flex-shrink-0">
                        <img src="{{ asset('images/bank.jpg') }}" alt="Bank" class="w-full h-full object-cover">
                    </div>
                ...
                <div class="metode-card border-2 border-neutral-200 rounded-xl p-4 flex items-center gap-4" onclick="pilihMetodeQRIS(this)">
                    <div class="w-12 h-12 bg-purple-100 rounded-xl overflow-hidden flex-shrink-0">
                        <img src="{{ asset('images/QRIS.jpg') }}" alt="QRIS" class="w-full h-full object-cover">
                    </div>
                ...
                <div class="metode-card border-2 border-neutral-200 rounded-xl p-4 flex items-center gap-4" onclick="pilihMetode(this,'Gopay')">
                    <div class="w-12 h-12 bg-yellow-100 rounded-xl overflow-hidden flex-shrink-0">
                        <img src="{{ asset('images/Gopay.jpg') }}" alt="Gopay" class="w-full h-full object-cover">
                    </div>
...
<div class="max-w-lg mx-auto px-6 py-14">
    ...
    <div class="anim-fade delay-2 bg-white rounded-3xl shadow-xl overflow-hidden">
        <div class="p-6 text-center" style="background:linear-gradient(135deg,#166534,#15803d);">
            ...
            <p class="text-green-300 text-xs mt-1">{{ $dataSukses['tanggal'] }}</p>
        </div>
        ...
        <div class="px-7 py-5 space-y-3.5">
            <div class="flex justify-between items-center text-sm"><span class="text-neutral-400">No. Transaksi</span><span class="font-semibold text-neutral-700 font-mono text-xs">{{ $dataSukses['no_trx'] }}</span></div>
            <div class="flex justify-between items-center text-sm"><span class="text-neutral-400">Nama Pemilik</span><span class="font-semibold text-neutral-800">{{ $user->username }}</span></div>
            <div class="flex justify-between items-center text-sm"><span class="text-neutral-400">Nomor Kios</span><span class="font-semibold text-neutral-800">{{ $dataSukses['kios'] }}</span></div>
            <div class="flex justify-between items-center text-sm"><span class="text-neutral-400">Jenis Pajak</span><span class="font-semibold text-neutral-800">Pajak {{ $dataSukses['jenis'] }}</span></div>
            <div class="flex justify-between items-center text-sm"><span class="text-neutral-400">Metode Bayar</span><span class="font-semibold text-neutral-800">{{ $dataSukses['metode'] }}</span></div>
        ...
        <div class="px-7 py-5 bg-green-50 text-center">
            ...
            <p class="font-extrabold text-4xl text-green-600" style="font-family:'Montserrat',sans-serif;">Rp {{ number_format($dataSukses['nominal'], 0, ',', '.') }}</p>
        </div>
    </div>

    <div class="anim-fade delay-3 grid grid-cols-2 gap-3 mt-6">
        <a href="{{ route('pedagang.riwayat') }}" class="py-3.5 border-2 border-green-600 text-green-700 rounded-2xl font-semibold text-sm text-center hover:bg-green-600 hover:text-white transition-all duration-300">Riwayat Pembayaran</a>
        <a href="{{ route('pedagang.pembayaran') }}" class="py-3.5 bg-white border-2 border-neutral-200 text-neutral-700 rounded-2xl text-center font-semibold text-sm hover:border-green-500 hover:text-green-600 transition-all duration-300">Bayar Lagi</a>
    </div>
</div>
@endif
