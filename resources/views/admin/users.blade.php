        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-5 py-4">
                        <span class="px-3 py-1 rounded-full text-xs font-semibold {{ $u->role==='admin'?'bg-red-100 text-red-700':($u->role==='pengawas'?'bg-blue-100 text-blue-700':'bg-green-100 text-green-700') }}">{{ ucfirst($u->role) }}</span>
                    </td>
                    <td class="px-5 py-4">
                        @if($u->no_kios)<span class="px-2 py-1 bg-blue-50 text-blue-700 font-bold text-xs rounded-lg">{{ $u->no_kios }}</span>
